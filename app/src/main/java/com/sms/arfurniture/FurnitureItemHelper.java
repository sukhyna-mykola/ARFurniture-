...
public class FurnitureItemHelper {
    ...
    private FurnitureItemHelper() {
        ...
        furnitureItems.add(new FurnitureItem(-1, FurnitureItem.FurnitureType.SHELF, "Shelf", "Shelf  description", "plus.png", "https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Models/master/1.0/WalkingLady/glTF/WalkingLady.gltf"));
